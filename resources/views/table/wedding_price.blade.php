...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Wedding Price Table</h3>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Wedding Price Table</h4>
                                <button
                                class="btn btn-primary btn-round ms-auto"
                                data-bs-toggle="modal" data-bs-target="#CategoryModal"
                                >
                                <i class="fa fa-plus"></i>
                                New Wedding Category Price
                                </button>
...
<div class="modal fade" id="editFuneralRecordModal" tabindex="-1" aria-labelledby="editFuneralRecordLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="editFuneralRecordForm" method="POST" action="{{ route('wedding.price.update') }}">
                @csrf
                @method('PUT') 
                <div class="modal-body">
    ...
    function confirmcancel(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '/funeral-price/delete/' + id;
            }
        });
    }
</script>
